const MESSAGE = {
  ...
  ADD_MEMBER_SUCCESS: 'Add members successfully',
  ...
  START_GAME_SUCCESS: 'Start game successfully',
  GAME_SUBMIT_SUCCESS: 'Your score was successfully submitted',
  GAME_ALREADY_STARTED: 'Game has already started',
  RESET_GAME_SUCCESS: 'Reset game successfully',
  FINISH_GAME_SUCCESS: 'Finish game successfully',
  PLAYER_NOT_CHOOSE_CARD: 'Some players not choose their cards',
  ...
  SELECT_CARD_IS_A_NUMBER: 'Selected card must be a number',
  OVER_LENGTH_COMMENT: 'Comment must be less than 256 character',
  IMAGE_TOO_LARGE:
